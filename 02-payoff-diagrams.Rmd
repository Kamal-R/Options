...
zoom = 2.5, file = "_book/img/02_Apple_Different_Strikes_Call_Relative_Payoff_Table.png") 
```
...
<figure style='margin-left:5%;'>
    ...
    <p> <img src='_book/img/02_Apple_Different_Strikes_Call_Relative_Payoff_Table.png' 
         style='height:auto; max-width:90%; border:none; display:block;' /> </p>
</figure>
