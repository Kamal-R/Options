...
zoom = 2.5, file = "02_Apple_Different_Strikes_Call_Relative_Payoff_Table.png") 
```

```{r Check-Working-Directory, echo = TRUE}
getwd()
list.files()
```
...
<figure style='margin-left:5%;'>
    ...
    <img src='02_Apple_Different_Strikes_Call_Relative_Payoff_Table.png' 
         style='height:auto; max-width:90%; border:none; display:block;' /> 
</figure>
