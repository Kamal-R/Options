...
```{r Apple-Call-Table, out.width = out_width_table, fig.align = "center", fig.cap = "Returns: 100 Shares vs. 1 Call."}
...
kableExtra:::save_kable(Apple_Call_Table, zoom = 2.5,
                        file="img/02_Apple_Call_Table.png") 
knitr::include_graphics(path="img/02_Apple_Call_Table.png") 
```
...
```{r Apple-Put-Table, out.width = out_width_table, fig.align = "center", fig.cap = "Returns: 100 Shares vs. 1 Put."}
Apple_Current_Price <- 205.44
Apple_Put_K <- 205
Apple_Put_Cost <- 6.10
...
kableExtra:::save_kable(Apple_Put_Table, zoom = 2.5,
                        file = "img/02_Apple_Put_Table.png") 
knitr::include_graphics(path="img/02_Apple_Put_Table.png")
```
...
```{r Apple-Different-Strikes-Table, fig.align = "center", out.width = "30%", fig.caption = "Cost on Sept. 11, 2019."}
...
knitr::include_graphics(path="img/02_Apple_Different_Strikes.png")
```
...
```{r Apple-Different-Strikes-Call-Payoff-Table, out.width = out_width_table, fig.align = "center", fig.cap = "Dollar Return if Held to Expiry"}
...
knitr::include_graphics(path="img/02_Apple_Different_Strikes_Call_Payoff_Table.png")
```
...
```{r Apple-Different-Strikes-Call-Relative-Payoff-Table, fig.cap = "Relative Return if Held to Expiry.", out.width = out_width_table, fig.align = "center"}
Apple_Future_Prices <- c(150, 200, 220, 245, 300)
Apple_Current_Price <- 222.76
...
knitr::include_graphics("img/02_Apple_Different_Strikes_Call_Relative_Payoff_Table.png")
```
