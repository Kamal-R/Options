...
options_theme <- function(legend_position="left") {
  ...
  theme(plot.title = element_text(hjust = 0.5, face="bold", 
        ...
        legend.position=c(ifelse(legend_position == "left",0,0.60),1), 
...
call_payoff <- function(data, main) {
  ...
  geom_hline(aes(yintercept = 0, color = "Breakeven"),
            linetype = "dashed") +
  geom_vline(aes(xintercept = Call_K + Call_cost, color = "Breakeven"), 
  ...
  scale_color_manual(values = c("Breakeven" = plot_fg, "Profit" = "green", "Loss" = "red"),
                     labels = c(paste0("Breakeven: ", currency(Call_K + Call_cost)), "", ""),
                     guide = "legend") + 
...
call_payoff(data = Call_Payoff_XYZ_230, main = "Buy: Company XYZ's $230 Strike Call")
```
