...
```{r Company-XYZ-Stock-Chapter-2, fig.align = "center", out.width = out_width_plot, message = FALSE}
Stock_cost <- 200
x_min = 160; x_max = 240
...
kableExtra:::save_kable(Apple_Call_Table, zoom = 3, file="img/02_Apple_Call_Table.png") 
```
...
kableExtra:::save_kable(Apple_Put_Table, zoom = 3, file = "img/02_Apple_Put_Table.png") 
```
...
<figure style='margin-left:10%;'>
    ...
    <p> <img src="img/02_Apple_Different_Strikes.png" 
         style='height:50%; width:50%; border:none; display:block;' /> </p>
</figure>
