...
Apple_Different_Strikes_Call_Relative_Payoff <- tibble( "Share Price" = currency(Apple_Future_Prices),
      ...
      "$145 Strike Call" = percent( sign(Apple_Future_Returns) / Apple_Future_Returns * 
                                        ( pmax( 0, (Apple_Future_Prices - 145 ) ) - 78.45 ) ),
      "$180 Strike Call" = percent( sign(Apple_Future_Returns) / Apple_Future_Returns * 
                                        ( pmax( 0, (Apple_Future_Prices - 180 ) ) - 44.85 ) ),
      "$205 Strike Call" = percent( sign(Apple_Future_Returns) / Apple_Future_Returns * 
                                        ( pmax( 0, (Apple_Future_Prices - 205 ) ) - 23.63 ) ), 
      "$230 Strike Call" = percent( sign(Apple_Future_Returns) / Apple_Future_Returns * 
