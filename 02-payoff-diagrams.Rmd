...
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Stock-Demo-1.png")}
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { 
  if ( local ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Call-Option-Payoff-Plot-1.png") }
  if ( !local ) { knitr::include_graphics("02-payoff-diagrams_files/figure-html/Call-Option-Payoff-Plot-1.png") }
}
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Stock-vs-Call-Payoff-Plot-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Put-Option-Payoff-Plot-1.png") }
```     
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Stock-vs-Put-Payoff-Plot-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Apple-Call-Payoff-Plot-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Apple-Put-Option-Payoff-Plot-1.png") }
```
...
<figure style='margin-left:30%;'>
    ...
    <p> <img src="img/02_Apple_Different_Strikes.png" 
         style='height:auto; max-width:40%; border:none; display:block;' /> </p>
</figure>
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("https://understanding-options.netlify.app/02-payoff-diagrams_files/figure-html/Apple-205-Strike-Call-Payoff-Plot-1.png") }
```
