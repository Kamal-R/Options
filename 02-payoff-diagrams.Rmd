...
```{r Apple-Call-Payoff, out.width = "80%", fig.align = "center", message = FALSE}
...
```{r Apple-Call-Table-Format, out.width="80%", fig.align = "center"}
...
Apple_Different_Strikes_Call_Payoff %>% 
...
Apple_Different_Strikes_Call_Relative_Payoff %>%
