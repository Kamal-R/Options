...
temp <- temp + scale_x_reverse() + xlab("Days to Expiry") + 
        ...
        annotate( geom = "text", x = 504-116, y = 16, color = "gray35", hjust = 0,
                  label = paste0("$15, 388 Days"), size = 4 ) +
        annotate("point", x = 504-116, y = 15, colour = "gray35", hjust = 0) + 
        ...
        annotate( geom = "text", x = 504-244, y = 16, color = "purple", hjust = 0,
                  label = paste0("$15, 260 Days"), size = 4 ) +
        annotate("point", x = 504-244, y = 15, colour = "purple", hjust = 0) + 
        ...
        annotate( geom = "text", x = 504-370, y = 16, color = "cornflowerblue", hjust = 0,
                  label = paste0("$15, 134 Days"), size = 4 ) +
        annotate("point", x = 504-370, y = 15, colour = "cornflowerblue", hjust = 0) + 
