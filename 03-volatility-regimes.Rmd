...
```{r Apple-Price-Volatility-Plots-2018, echo = FALSE, message = FALSE}
...
```{r Apple-Price-Volatility-Plots-2019, echo = FALSE, message = FALSE}
### The buy and sell regions are manually annoted (by me) 
Color <- rep("black", 252)
...
```{r Amazon-Price-Volatility-Plots, echo = FALSE}
Amazon_Price_data <- ds.getSymbol.yahoo("AMZN", from = "2010-06-01", to = "2020-08-12")
Amazon_Price_data <- tibble( "Date" = as.Date(as.character(index(Amazon_Price_data))), 
                             "Price" = as.vector(Amazon_Price_data$Amazon.Close) )
