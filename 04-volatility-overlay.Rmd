...
Understanding volatility is essential for being able to effective trade and risk-manage options positions. Revisting the straddle is one of the easiest ways to see the important role that volatility plays in determining the price of options. 

```{r Volatility-Straddle-Overlay}
