# Options at Expiry {Options-At-Expiry}
...
``` {r Set-Global_Chapter_One-Variables, echo = FALSE}
plot_bg <- "#191919"
plot_fg <- "#929292"
```
...
Distinguishing bewteen the time and intrinsic value of an option has another advantage - it will serve as our foundation while we work through how to price and trade options before their expiry date. We'll discuss option pricing in much more detail later on. For this chapter, we've focused on building intuition behind a few big picture ideas that we'll be using for the rest of the book.