...
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Protective-Put-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Covered-Call-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Collar-Left-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Collar-Right-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Stock-Demo-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-combining_payoffs_files/figure-html/XYZ-Synthetic-Long-1.png") }
```
