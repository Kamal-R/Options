...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("03-payoff-diagrams_files/figure-html/XYZ-Covered-Call-1.png") }
```
...
if ( !output_epub ) { print(temp); rm(temp) }
if ( output_epub ) { knitr::include_graphics("02-payoff-diagrams_files/figure-html/XYZ-Stock-Demo-1.png") }
```
