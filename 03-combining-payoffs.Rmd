...
The straddle combines two options positions -- a long call and a long put. Unlike the protective put and covered call, we don't own any shares in this position. The put makes money if the stock falls a lot, and the call makes money if the stock goes up a lot. The beauty of the straddle is that it is profitable regardless of the direction the stock moves. You don't have to get the direction right to make money. The downside is that the moves have to be large enough to pay back the cost of the long call and long put.
...
temp; rm(temp)
```
Here, we can see a \$200 strike call that cost \$10/share and a \$200 strike put that cost \$15/share. To make money, the straddle has to move more than \$25 in either direction. That's below \$175 if it heads lower, and above \$225 if it heads higher. 
