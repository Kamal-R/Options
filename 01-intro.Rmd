...
Apple_Call_Table <- data.frame( "Stock Price" = currency(Apple_Stock_Price),
...
add_header_above( kable_styling( knitr::kable(x = Apple_Call_Table, booktabs = TRUE, longtable = TRUE, align = "c",
