...
Testing. Testing inline: <span class="fraction" data-top="`r currency(Apple_Call_Strike_Price+2*Apple_Call_Cost)` - `r currency(Apple_Share_Price)`" data-bottom="`r currency(Apple_Share_Price)`"></span>. Testing. 
