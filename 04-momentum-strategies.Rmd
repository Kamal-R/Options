...
```{r Payoff-SPY-3*325-vs-4*Bull-Call-Spread-Expiry, out.width = "80%", fig.align = "center", message = FALSE}
Call_cost_322 <- 0.36; Call_cost_325 <- 0.16
Call_K_322 <- 322; Call_K_325 <- 325
x_min <- 310; x_max = 335
Call_Payoff_Plot <- tibble( "Call_x" = seq(from = x_min, to = x_max, by = 1),
...
```{r Payoff-SPY-2*322-vs-4*Bull-Call-Spread-Expiry, out.width = "80%", fig.align = "center", message = FALSE}
Call_cost_322 <- 0.36; Call_cost_325 <- 0.16
Call_K_322 <- 322; Call_K_325 <- 325
x_min <- 310; x_max = 335
Call_Payoff_Plot <- tibble( "Call_x" = seq(from = x_min, to = x_max, by = 1),
