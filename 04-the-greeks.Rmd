...
It's essential that you learn the *greeks*, so that you can:
...
Once we've armed ourselves with knowledge of the greeks, we'll look at two more options strategies - the straddle and the put spread - to show how to use the greeks to construct and manage an options trade. 

That's all coming up. In this chapter, we're going to start by  with *delta* and *gamma*. 

## Delta 

Here's a familiar payoff diagram - Apple's \$205 strike call. What does it say about the call's *delta*?
