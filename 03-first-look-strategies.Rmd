...
```{r Apple-Sell-Call-Option-Payoff, out.width = out_width_plot, fig.align = "center", message = FALSE}
Apple_Call_Cost <- 8.50
Apple_Call_K <- 230
x_min <- 210; x_max = 260
...
```{r Apple-Covered-Call-Payoff-Plot, out.width = out_width_plot, fig.align = "center", message = FALSE}
Apple_Call_Cost <- 8.50
Apple_Call_K <- 230
x_min <- 190; x_max = 260 
Call_x <- seq(from = x_min, to = x_max, by = 1)
...
```{r Apple-Covered-Call-Different-Strikes-Table, out.width = out_width_table, fig.align = "center", message = FALSE}
...
Apple_Covered_Call <- knitr::kable(Apple_Covered_Call, 
                                   caption = "Dollar Return if Held to Expiry") %>%
  kable_styling( bootstrap_options = c("bordered", "condensed", "responsive"),
                 full_width = FALSE )
```

```{r Apple-Covered-Call-Different-Strikes-Table-Format, out.width = out_width_table, fig.align = "center"}
if (save_tables_as_pictures) { save_kable(Apple_Protective_Put, file="img/03_Apple_Covered_Call.png") }
if (load_table_pictures) { knitr::include_graphics(path="img/03_Apple_Covered_Call.png") }
```
...
```{r Apple-145-Covered-Call-Payoff-Plot, out.width = out_width_plot, fig.align = "center", message = FALSE}
...
```{r Apple-Covered-Call-Different-Strikes-Relative-Table, out.width = out_width_table, fig.align = "center", message = FALSE}
Apple_Future_Prices <- c(100, 150, 200, 220, 245, 300)
Apple_Current_Price <- 222.76
...
Apple_Covered_Call_Relative <- knitr::kable(Apple_Covered_Call_Relative, 
                                            caption = "Relative Return if Held to Expiry") %>%
  kable_styling( bootstrap_options = c("bordered", "condensed", "responsive"),
                 full_width = FALSE )
```

```{r Apple-Covered-Call-Different-Strikes-Relative-Table-Format, out.width = out_width_table, fig.align = "center"}
if (save_tables_as_pictures) { save_kable(Apple_Protective_Put, file="img/03_Apple_Covered_Call_Relative.png") }
if (load_table_pictures) { knitr::include_graphics(path="img/03_Apple_Covered_Call_Relative.png") }
```
...
```{r Apple-Protective-Put-205-Strike-Table, out.width = out_width_table, fig.align = "center", message = FALSE}
Apple_Future_Prices <- c(100, 150, 200, 220, 245, 300)
Apple_Current_Price <- 222.76
Apple_Put_K <- 205
...
Apple_Protective_Put <- knitr::kable( Apple_Protective_Put, escape = FALSE,
                                      caption = "Dollar Return if Held to Expiry" ) %>%
  kable_styling ( bootstrap_options = c("bordered", "condensed", "responsive"),
                  full_width = FALSE )
```

```{r Apple-Call-Apple-Protective-Put-205-Strike-Table-Format, out.width = out_width_table, fig.align = "center"}
if (save_tables_as_pictures) { save_kable(Apple_Protective_Put, file="img/03_Apple_Protective_Put.png") }
if (load_table_pictures) { knitr::include_graphics(path="img/03_Apple_Protective_Put.png") }
```
